        ...
        <section class="bg-gray-100">
                    <div class="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
                            <div class="max-w-lg">
                                <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl">Truly Unique Experience</h2>
                                <p class="mt-4 text-gray-600 text-lg">Discover a fusion of vibrant Mexican flavors and traditional Asian boba teas at Boba Muy Rico, where every sip tells a story of cultural harmony.</p>
                                {/* <div class="mt-8">
                ...
                <div class="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
                        ...
                        <div class="max-w-lg">
                            ...
                            <p class="mt-4 text-gray-600 text-lg">Our drinks are made from the finest ingredients, making use of only high-quality tea leaves. The leaves and ingredients are tested to ensure the best possible quality across our lineup of beverages.</p>
                            {/* <div class="mt-8">
                                <a href="#" class="text-blue-500 hover:text-blue-600 font-medium">Learn more about us
                                    <span class="ml-2">&#8594;</span></a>
                            </div> */}
